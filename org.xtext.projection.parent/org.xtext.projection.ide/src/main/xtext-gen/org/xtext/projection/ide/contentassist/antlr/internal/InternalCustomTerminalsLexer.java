...
public class InternalCustomTerminalsLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalCustomTerminals.g:145:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCustomTerminals.g:145:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalCustomTerminals.g:145:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalCustomTerminals.g:145:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:147:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCustomTerminals.g:147:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalCustomTerminals.g:147:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
            ...
            // InternalCustomTerminals.g:147:40: ( ( '\\r' )? '\\n' )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalCustomTerminals.g:147:41: ( '\\r' )? '\\n'
                    {
                    // InternalCustomTerminals.g:147:41: ( '\\r' )?
                    int alt3=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:149:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCustomTerminals.g:149:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCustomTerminals.g:149:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:151:19: ( '--' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalCustomTerminals.g:151:21: '--' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("--"); 

            // InternalCustomTerminals.g:151:26: (~ ( ( '\\r' | '\\n' ) ) )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_LINE_COMMENT2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:153:20: ( '//' (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )? (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalCustomTerminals.g:153:22: '//' (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )? (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//"); 

            // InternalCustomTerminals.g:153:27: (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )?
            int alt7=2;
            ...
            // InternalCustomTerminals.g:153:55: (~ ( ( '\\r' | '\\n' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_ALERT_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:155:25: ( '//!' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalCustomTerminals.g:155:27: '//!' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//!"); 

            // InternalCustomTerminals.g:155:33: (~ ( ( '\\r' | '\\n' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_QUESTION_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:157:28: ( '//?' ( '\\r' | '\\n' )* )
            // InternalCustomTerminals.g:157:30: '//?' ( '\\r' | '\\n' )*
            {
            match("//?"); 

            // InternalCustomTerminals.g:157:36: ( '\\r' | '\\n' )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_GOOD_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:159:24: ( '//=' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalCustomTerminals.g:159:26: '//=' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//="); 

            // InternalCustomTerminals.g:159:32: (~ ( ( '\\r' | '\\n' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_REGION_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:161:21: ( '---' ( '-' )+ ' ' ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+ ( '-' )+ )
            // InternalCustomTerminals.g:161:23: '---' ( '-' )+ ' ' ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+ ( '-' )+
            {
            match("---"); 

            // InternalCustomTerminals.g:161:29: ( '-' )+
            int cnt12=0;
            loop12:
            do {
                int alt12=2;
            ...
            match(' '); 
            // InternalCustomTerminals.g:161:38: ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+
            int cnt14=0;
            loop14:
            do {
                int alt14=2;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalCustomTerminals.g:161:39: ( 'A' .. 'Z' | '0' .. '9' )+ ' '
            	    {
            	    // InternalCustomTerminals.g:161:39: ( 'A' .. 'Z' | '0' .. '9' )+
            	    int cnt13=0;
            	    loop13:
            ...
            // InternalCustomTerminals.g:161:66: ( '-' )+
            int cnt15=0;
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_TIME() throws RecognitionException {
        try {
            int _type = RULE_TIME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:163:11: ( ( '0' .. '9' )+ ':' ( '0' .. '9' )+ )
            // InternalCustomTerminals.g:163:13: ( '0' .. '9' )+ ':' ( '0' .. '9' )+
            {
            // InternalCustomTerminals.g:163:13: ( '0' .. '9' )+
            int cnt16=0;
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // InternalCustomTerminals.g:163:14: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match(':'); 
            // InternalCustomTerminals.g:163:29: ( '0' .. '9' )+
            int cnt17=0;
            loop17:
            do {
                int alt17=2;
                ...
                switch (alt17) {
            	case 1 :
            	    // InternalCustomTerminals.g:163:30: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_CAMELCASE_IDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:165:27: ( 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )* )
            // InternalCustomTerminals.g:165:29: 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )*
            {
            matchRange('a','z'); 
            // InternalCustomTerminals.g:165:38: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:167:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
            // InternalCustomTerminals.g:167:16: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
            {
            // InternalCustomTerminals.g:167:16: ( '0' .. '9' )+
            int cnt19=0;
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalCustomTerminals.g:167:17: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match('.'); 
            // InternalCustomTerminals.g:167:32: ( '0' .. '9' )+
            int cnt20=0;
            loop20:
            do {
                int alt20=2;
                ...
                switch (alt20) {
            	case 1 :
            	    // InternalCustomTerminals.g:167:33: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_CHARACTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:169:16: ( '\\'' ~ ( '\\'' ) '\\'' )
            // InternalCustomTerminals.g:169:18: '\\'' ~ ( '\\'' ) '\\''
            {
            match('\''); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:171:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalCustomTerminals.g:171:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalCustomTerminals.g:171:11: ( '^' )?
            int alt21=2;
            ...
            // InternalCustomTerminals.g:171:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:173:10: ( ( '0' .. '9' )+ )
            // InternalCustomTerminals.g:173:12: ( '0' .. '9' )+
            {
            // InternalCustomTerminals.g:173:12: ( '0' .. '9' )+
            int cnt23=0;
            loop23:
            do {
                ...
                switch (alt23) {
            	case 1 :
            	    // InternalCustomTerminals.g:173:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCustomTerminals.g:175:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalCustomTerminals.g:175:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalCustomTerminals.g:175:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    // InternalCustomTerminals.g:175:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCustomTerminals.g:175:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop24:
                    do {
                        int alt24=3;
                        ...
                        switch (alt24) {
                    	case 1 :
                    	    // InternalCustomTerminals.g:175:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalCustomTerminals.g:175:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalCustomTerminals.g:175:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCustomTerminals.g:175:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop25:
                    do {
                        int alt25=3;
                        ...
                        switch (alt25) {
                    	case 1 :
                    	    // InternalCustomTerminals.g:175:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalCustomTerminals.g:175:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            // InternalCustomTerminals.g:177:18: .
            {
            matchAny(); 
