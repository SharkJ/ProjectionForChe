...
public class InternalProjectionLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:678:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalProjection.g:678:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalProjection.g:678:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:680:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalProjection.g:680:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalProjection.g:680:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:682:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalProjection.g:682:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalProjection.g:682:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:684:19: ( '--' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalProjection.g:684:21: '--' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("--"); 

            // InternalProjection.g:684:26: (~ ( ( '\\r' | '\\n' ) ) )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_LINE_COMMENT2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:686:20: ( '//' (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )? (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalProjection.g:686:22: '//' (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )? (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//"); 

            // InternalProjection.g:686:27: (~ ( ( '!' | '?' | '=' | '\\r' | '\\n' ) ) )?
            int alt7=2;
    ...
    public final void mRULE_ALERT_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:688:25: ( '//!' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalProjection.g:688:27: '//!' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//!"); 

            // InternalProjection.g:688:33: (~ ( ( '\\r' | '\\n' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_QUESTION_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:690:28: ( '//?' ( '\\r' | '\\n' )* )
            // InternalProjection.g:690:30: '//?' ( '\\r' | '\\n' )*
            {
            match("//?"); 

            // InternalProjection.g:690:36: ( '\\r' | '\\n' )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_GOOD_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:692:24: ( '//=' (~ ( ( '\\r' | '\\n' ) ) )* )
            // InternalProjection.g:692:26: '//=' (~ ( ( '\\r' | '\\n' ) ) )*
            {
            match("//="); 

            // InternalProjection.g:692:32: (~ ( ( '\\r' | '\\n' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_REGION_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:694:21: ( '---' ( '-' )+ ' ' ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+ ( '-' )+ )
            // InternalProjection.g:694:23: '---' ( '-' )+ ' ' ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+ ( '-' )+
            {
            match("---"); 

            // InternalProjection.g:694:29: ( '-' )+
            int cnt12=0;
            loop12:
            do {
                int alt12=2;
            ...
            match(' '); 
            // InternalProjection.g:694:38: ( ( 'A' .. 'Z' | '0' .. '9' )+ ' ' )+
            int cnt14=0;
            loop14:
            do {
                int alt14=2;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalProjection.g:694:39: ( 'A' .. 'Z' | '0' .. '9' )+ ' '
            	    {
            	    // InternalProjection.g:694:39: ( 'A' .. 'Z' | '0' .. '9' )+
            	    int cnt13=0;
            	    loop13:
    ...
    public final void mRULE_TIME() throws RecognitionException {
        try {
            int _type = RULE_TIME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:696:11: ( ( '0' .. '9' )+ ':' ( '0' .. '9' )+ )
            // InternalProjection.g:696:13: ( '0' .. '9' )+ ':' ( '0' .. '9' )+
            {
            // InternalProjection.g:696:13: ( '0' .. '9' )+
            int cnt16=0;
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // InternalProjection.g:696:14: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match(':'); 
            // InternalProjection.g:696:29: ( '0' .. '9' )+
            int cnt17=0;
            loop17:
            do {
                int alt17=2;
                ...
                switch (alt17) {
            	case 1 :
            	    // InternalProjection.g:696:30: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_CAMELCASE_IDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:698:27: ( 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )* )
            // InternalProjection.g:698:29: 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )*
            {
            matchRange('a','z'); 
            // InternalProjection.g:698:38: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '$' | '#' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:700:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
            // InternalProjection.g:700:16: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
            {
            // InternalProjection.g:700:16: ( '0' .. '9' )+
            int cnt19=0;
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalProjection.g:700:17: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match('.'); 
            // InternalProjection.g:700:32: ( '0' .. '9' )+
            int cnt20=0;
            loop20:
            do {
                int alt20=2;
                ...
                switch (alt20) {
            	case 1 :
            	    // InternalProjection.g:700:33: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_CHARACTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:702:16: ( '\\'' ~ ( '\\'' ) '\\'' )
            // InternalProjection.g:702:18: '\\'' ~ ( '\\'' ) '\\''
            {
            match('\''); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:704:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalProjection.g:704:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalProjection.g:704:11: ( '^' )?
            int alt21=2;
            ...
            // InternalProjection.g:704:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:706:10: ( ( '0' .. '9' )+ )
            // InternalProjection.g:706:12: ( '0' .. '9' )+
            {
            // InternalProjection.g:706:12: ( '0' .. '9' )+
            int cnt23=0;
            loop23:
            do {
                ...
                switch (alt23) {
            	case 1 :
            	    // InternalProjection.g:706:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:708:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalProjection.g:708:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalProjection.g:708:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    // InternalProjection.g:708:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalProjection.g:708:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop24:
                    do {
                        int alt24=3;
                    ...
                    break;
                case 2 :
                    // InternalProjection.g:708:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalProjection.g:708:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop25:
                    do {
                        int alt25=3;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProjection.g:710:16: ( . )
            // InternalProjection.g:710:18: .
            {
            matchAny(); 
